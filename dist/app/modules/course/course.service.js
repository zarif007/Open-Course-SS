...
const getCourses = query =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const course of results) {
      courses.push(
        Object.assign(Object.assign({}, course.toObject()), {
          creator: yield getCreator(course.creator),
          id: course._id,
        })
      );
    }
...
const getSingleCourse = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const course = Object.assign(
      ...
      {
        creator: yield getCreator(
          result === null || result === void 0 ? void 0 : result.creator
        ),
...
const getSingleCourseBySlug = slug =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield course_model_1.Course.findOne({ slug }).populate(
      'topics'
    );
    const course = Object.assign(
      Object.assign(
...
const createCourse = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield course_model_1.Course.create(
      Object.assign(Object.assign({}, payload), { topics: topicIds })
    );
