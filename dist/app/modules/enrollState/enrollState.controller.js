...
const updateEnrollState = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const enrollState = req.body;
    const result = yield enrollState_service_1.EnrollStateService.updateEnrollState(enrollState);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
